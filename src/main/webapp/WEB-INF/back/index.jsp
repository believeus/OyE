	 ...
	 var _menus = {"menus":[
			{"menuid":"1","icon":"icon-sys","menuname":"内容管理",
				"menus":[
						...
						{"menuname":"客户感言管理","icon":"icon-set","url":"/admin/partners/list.jhtml"},
						</shiro:hasPermission>
						...
						{"menuname":"联系我们管理","icon":"icon-nav","url":"/admin/contactus/conlist.jhtml"},
						</shiro:hasPermission>
						
						<shiro:hasPermission name="oye:view">  	
						{"menuname":"关于欧耶管理","icon":"icon-nav","url":"/admin/oye/list.jhtml"},
						</shiro:hasPermission>
					]
			}
